...
@NonNullApi
public class ExpenseTrackerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public ExpenseTrackerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
